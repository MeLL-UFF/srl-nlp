...
class Parser:
    ...
    def printInfo(self):
        ...
        print(f"Grammar\t{Numberer.getGlobalNumberer('states').total()}\t"
              f"{Numberer.getGlobalNumberer('tags').total()}\t{Numberer.getGlobalNumberer('words').total()}\t"
              f"{self.parser.pparser.ug.numRules()}\t{self.parser.pparser.bg.numRules()}\t"
              f"{self.parser.pparser.lex.numRules()}")
